...
export interface Department {
  ...
  name: string;
  description: string;
  organizationId?: string;  // Make optional since it might not be in response
  statistics: {  // Add statistics object from API
    totalCourses: number;
    totalEmployees: number;
    totalEnrollments: number;
  };
  courses?: Course[];  // Add courses array from API
  createdAt?: string;  // Make optional since API might not include it
